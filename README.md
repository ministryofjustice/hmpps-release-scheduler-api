# hmpps-release-scheduler-api

[![Ministry of Justice Repository Compliance Badge](https://github-community.service.justice.gov.uk/repository-standards/api/hmpps-release-scheduler-api/badge?style=flat)](https://github-community.service.justice.gov.uk/repository-standards/hmpps-release-scheduler-api)
[![Docker Repository on ghcr](https://img.shields.io/badge/ghcr.io-repository-2496ED.svg?logo=docker)](https://ghcr.io/ministryofjustice/hmpps-release-scheduler-api)
[![API docs](https://img.shields.io/badge/API_docs_-view-85EA2D.svg?logo=swagger)](https://release-scheduler-api-dev.hmpps.service.justice.gov.uk/swagger-ui/index.html)
...
Our security policy is located [here](https://github.com/ministryofjustice/hmpps-release-scheduler-api/security/policy).
...
## Renaming from HMPPS Release Scheduler Api - github Actions
...
```bash
docker compose pull && docker compose up --scale hmpps-release-scheduler-api=0
```
